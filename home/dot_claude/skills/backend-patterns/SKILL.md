...
description: Backend architecture patterns, API design, database optimization, and server-side best practices. Load when building REST APIs, designing database schemas, implementing authentication, or working with Node.js, Express, and Next.js API routes.
---
